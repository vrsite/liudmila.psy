  ...
  const blogData = {
      1: {
          ...
          text: `
              ...
              <p>Якщо ви відчуваєте, що готові не просто тимчасово справлятися з тривогою, а змінити своє життя, я запрошую вас на першу безкоштовну консультацію.</p>
          `
      },
      2: {
      ...
      3: {
          ...
          text: `
              ...
              <p>Якщо ви готові не просто тимчасово полегшити симптоми, а знайти справжню гармонію між тілом і душею, я запрошую вас на першу безкоштовну консультацію.</p>
          `
      },
      4: {
          ...
          text: `
              ...
              <p>Я запрошую вас на безкоштовну консультацію, де ми знайдемо корінь вашої нерішучості і розробимо індивідуальну стратегію.</p>
          `
      }
  };
